<template>
    <footer class="bg-very-light-gray background-position-center-top pb-3 footer-sticky" style="background-image: url(https://cxcrodrigues.github.io/apoiofacil_website/images/vertical-line-bg-small-medium-gray.svg)">
            <div class="container">
                ...
                <div class="row row-cols-2 row-cols-lg-6 row-cols-md-3 instagram-follow-api position-relative mb-5 sm-mb-30px">
                </div>
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-4 me-auto last-paragraph-no-margin text-center text-md-start order-3 order-md-first"> 
                        <p class="fs-15">&COPY; 2024 - Todos os direitos reservados</p>
                    </div>
